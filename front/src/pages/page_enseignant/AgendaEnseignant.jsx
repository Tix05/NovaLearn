...
import LayoutEnseignant from '../../components/LayoutEnseignant';
import AgendaEnseignantService from '../../Services/agendaEnseignantService';
    ...
    useEffect(() => {
        const fetchAgenda = async () => {
            try {
                setLoading(true);
                setError(null);
                const data = await AgendaEnseignantService.getTeacherAgenda();
                setAgendaData(data);
            } catch (error) {
