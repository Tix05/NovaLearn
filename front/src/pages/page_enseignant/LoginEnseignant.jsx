        ...
        <motion.div
            ...
            <div
                ...
                <div className='flex flex-col items-center justify-center space-y-3'>
                    <h1 className='font-bold text-2xl'>ESPACE ENSEIGNANT</h1>
                ...
                <form action="" className='flex-col mt-10 items-center flex space-y-10'>
                    <div className="custom-float-label-container flex shadow-2xl">
                        ...
                        <FloatLabel className="custom-float-label">
                            <InputText id="email" className='input-focus' value={email} onChange={(e) => setValue(e.target.value)} />
                    ...
                    <div className="custom-password-container flex shadow-2xl">
                        ...
                        <FloatLabel className="custom-float-label">
                            <Password id="mdp" className='password-focus' value={mdp} onChange={(e) => setValue(e.target.value)} />
                ...
                <div className='flex flex-col items-center mt-3 space-y-3'>
                    <Link to="/enseignant/forgot-password-teacher" className='font-semibold text-sm text-gray-700 hover:scale-105 duration-500'>Mot de passe oublié ?</Link>
                </div>
            </div>
        </motion.div>
    );
