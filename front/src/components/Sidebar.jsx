...
export default function Sidebar({ isMobile, isSidebarVisible, toggleSidebar }) {
    ...
    return (
        <>
            <nav className={`
                h-full p-2 flex flex-col justify-between duration-300 bg-white text-gray-700 shadow-2xl border-r-[1px] border-gray-500
                ${open ? 'w-60' : 'w-14'}
            ...
            `}>
                <div className="space-y-5 flex flex-col justify-between">
                    <div className='px-2 flex flex-col justify-between space-y-5 items-center'>
                        <div
                        ...
                        <img src={logo} alt="Logo" className={`${open ? 'w-[150px]' : 'w-0'} rounded-md`} />
                    </div>
                    <ul>
                        {menuItems.map((item, index) => {
                            ...
                            return (
                                ...
                                ${isActive ? 'bg-emerald-600 text-white' : 'hover:bg-gray-300'}`}
                                >
                                    <Link
