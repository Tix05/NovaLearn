        ...
        <motion.div
            ...
            <div
                ...
                <div className='flex items-center justify-center mt-3 space-x-2 text-sm'>
                    ...
                    <Link to="/enseignant/login-enseignant" className='font-semibold text-blue-500 hover:scale-105 duration-500'>Se connecter</Link>
                </div>
            </div>
        </motion.div>
    );
...
export default ForgotPasswordProf;