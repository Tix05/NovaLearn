...
import { getConversations, getMessages, sendMessage, markMessageAsRead } from '../../Services/messagingEnseignantService';
import { getCurrentTeacher } from '../../Services/teacherAuthService';
import { ProgressSpinner } from 'primereact/progressspinner';

function MessageEnseignant() {
    ...
    const getConversationTitle = (conv) => {
        ...
        if (conv.type === 'GROUPE_PROFESSEUR_FILIERE') {
            return `Groupe ${conv.sujet || 'Filière'}`;
        }
        if (conv.type === 'ADMIN') {
...
export default MessageEnseignant;